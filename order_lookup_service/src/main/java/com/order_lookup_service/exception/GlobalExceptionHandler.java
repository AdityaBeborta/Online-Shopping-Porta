...
public class GlobalExceptionHandler {
	...
	@ExceptionHandler(CustomerDontHaveOrderException.class)
	public ResponseEntity<ApiResponse> pageNumber(CustomerDontHaveOrderException e) {
		
		ApiResponse api = new ApiResponse(e.getMessage(), false);
		return new ResponseEntity<ApiResponse>(api, HttpStatus.NOT_FOUND);
	}
	@ExceptionHandler(HttpServerErrorException.class)
	public ResponseEntity<ApiResponse> pageNumber(HttpServerErrorException e) {

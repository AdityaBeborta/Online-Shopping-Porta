...
public class AppConfig {
	...
	@Bean
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).apiInfo(getInfo()).select().apis(RequestHandlerSelectors.basePackage("com.item"))
				.paths(PathSelectors.any()).build();
	}

	private ApiInfo getInfo() {
		@SuppressWarnings("unchecked")
		ApiInfo apiInfo = new ApiInfo("Item Service : Backend Application",
